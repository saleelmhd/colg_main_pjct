...
$sql1=mysqli_query($con, "SELECT  * FROM bookings join station_tb on station_tb.station_id = bookings.station_id join login_tb on login_tb.login_id = bookings.user_id where bookings.status='0' and bookings.user_id ='$id'");
$list=array();
if($sql1->num_rows>0){
